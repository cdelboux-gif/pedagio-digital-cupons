...
export const modules = ["dashboard", "partners", "campaigns", "coupons", "uses", "stores", "entities", "integrations", "access", "audit", "emails", "notifications", "intelligence", "agents"] as const;
...
const matrix: Record<AccessLevel, Partial<Record<PermissionModule, PermissionAction[]>>> = {
  ...
  manager: {
    dashboard: ["read"], partners: ["read", "create", "update", "delete", "status"], campaigns: ["read", "create", "update", "status", "manage"], coupons: ["read", "create", "update", "delete", "status"], uses: ["read", "create"], stores: ["read", "create", "update", "delete", "status"], entities: ["read"], audit: ["read"], emails: ["read"], notifications: ["read", "create", "update"], intelligence: ["read", "create", "update", "status", "manage"], agents: ["read", "create", "update", "manage"],
  },
  operator: {
    dashboard: ["read"], partners: ["read"], campaigns: ["read"], coupons: ["read"], uses: ["read", "create"], stores: ["read"], entities: ["read"], notifications: ["read"], intelligence: ["read"], agents: ["read"],
  },
  viewer: {
    dashboard: ["read"], partners: ["read"], campaigns: ["read"], coupons: ["read"], uses: ["read"], stores: ["read"], entities: ["read"], notifications: ["read"], intelligence: ["read"], agents: ["read"],
  },
};
