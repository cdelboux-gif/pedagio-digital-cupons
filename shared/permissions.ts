...
export const modules = ["dashboard", "partners", "coupons", "uses", "stores", "entities", "integrations", "access", "audit", "emails", "notifications", "intelligence"] as const;
...
const matrix: Record<AccessLevel, Partial<Record<PermissionModule, PermissionAction[]>>> = {
  ...
  manager: {
    dashboard: ["read"], partners: ["read", "create", "update", "delete", "status"], coupons: ["read", "create", "update", "delete", "status"], uses: ["read", "create"], stores: ["read", "create", "update", "delete", "status"], entities: ["read"], audit: ["read"], emails: ["read"], notifications: ["read", "create", "update"], intelligence: ["read", "create", "update", "status", "manage"],
  },
  operator: {
    dashboard: ["read"], partners: ["read"], coupons: ["read"], uses: ["read", "create"], stores: ["read"], entities: ["read"], notifications: ["read"], intelligence: ["read"],
  },
  viewer: {
    dashboard: ["read"], partners: ["read"], coupons: ["read"], uses: ["read"], stores: ["read"], entities: ["read"], notifications: ["read"], intelligence: ["read"],
  },
};
