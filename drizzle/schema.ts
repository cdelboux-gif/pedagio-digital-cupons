...
export const auditResourceValues = ["access", "login_invite", "entity", "partner", "store", "coupon", "toll_plaza", "integration", "email_sender", "email_template", "email_rule", "email_outbox", "notification_template", "notification_rule", "notification_outbox", "agent_profile", "agent_run", "agent_feedback"] as const;
...
export const recommendationDeliveries = mysqlTable(
  "recommendationDeliveries",
  {
    ...
    disclosureJson: text("disclosureJson"),
    decisionContextJson: text("decisionContextJson"),
