...
import { Building2, Edit3, ExternalLink, Mail, MapPin, Navigation, Phone, Plus, Search, SlidersHorizontal, UsersRound } from "lucide-react";
...
export default function Partners() {
  ...
  function savePartner() {
    const data = {
      ...
      relationshipStatus: form.relationshipStatus, notes: emptyToNull(form.notes ?? ""),
    };
